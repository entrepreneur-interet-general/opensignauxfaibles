...
```{r}
res <- light_gradient_boosting(database, actual_period, last_batch, algorithm, min_effectif)
...
```{r results="hide"}
export_fiche_visite(sirets = c("47885488800029", "40237448200014"), database, last_batch, with_urssaf = TRUE)
```
